<template>
  <div class="chat-container">
    ...
    <div class="page-header">
      <h2>闲聊灌水</h2>
      <p class="subtitle">轻松聊天，分享生活点滴</p>
    </div>
    ...
    <!-- 发帖对话框 -->
    <el-dialog v-model="postDialogVisible" title="发布闲聊灌水" width="600px">
...
.post-btn {
  ...
  border: none;
  box-shadow: 0 4px 15px rgba(50, 61, 63, 0.3);
  transition: all 0.3s;
}
